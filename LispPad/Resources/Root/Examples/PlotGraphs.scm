...
;;;   (plot sin 0 9.4 50)
;;;   (plot (lambda (x) (* (sin (* x 2)) (cos (/ x 4)))) 0 12.55 50 red)
;;; 
...
(define combined
  (drawing
    ...
    (draw-drawing (plot (lambda (x) (* (sin (* x 2)) (cos (/ x 4))))
      -1 6.3 50 red (rect 10 140 200 100) "sin(x*2)*cos(x/4)"))
    (draw-drawing (plot (lambda (x) (/ (* x x) 40))
      -1 6.3 50 green (rect 220 140 200 100) "x*x/40"))))
